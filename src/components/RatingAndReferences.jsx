...
import "../components/RatingAndReferences.css"
...
<div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1rem' }}>
    <div style={{ textAlign: 'center' }}>
      ...
      <Typography variant="subtitle1" color="textSecondary">
        Provide highlights of your awards, current customers,peers and reviews with prospective customers
      </Typography>
    </div>
    <div>
...
export default RatingAndReferences;
